...
#endif
#ifndef TEMP_1_PIN
  #define TEMP_1_PIN                          -1//14  // Analog Input
#endif
#ifndef TEMP_2_PIN
  #define TEMP_2_PIN                          -1//15  // Analog Input
#endif
#ifndef TEMP_3_PIN
  #define TEMP_3_PIN                          -1//12  // Analog Input
#endif
#ifndef TEMP_BED_PIN
...
#define TRIGORILLA_FAN0_PIN        RAMPS_D9_PIN   // Anycubic Kossel: Usually the part cooling fan
#define TRIGORILLA_FAN1_PIN        7   // Anycubic Kossel: Unused
#define TRIGORILLA_FAN2_PIN       44   // Anycubic Kossel: Hotend fan

#define HEATER_0_PIN               TRIGORILLA_HEATER_0_PIN

#if ENABLED(IS_RAMPS_EFB)                         // Hotend, Fan, Bed
  #define HEATER_BED_PIN            TRIGORILLA_HEATER_1_PIN
