...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN TRIGORILLA_FAN1_PIN           // Set a custom pin for the controller fan
...
#define HOMING_BACKOFF_MM { 2, 2, 20 }  // (mm) Move away from the endstops after homing
 ...
 */
  ...
  #define PROBE_PT_2_X 385
  #define PROBE_PT_2_Y 55
  #define PROBE_PT_3_X 385
  #define PROBE_PT_3_Y 345
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      330  // (mm) The length of filament for a complete unload.
