...
//#define PSU_NAME "Power Supply"
  ...
  // #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_CHAMBER_TEMP  10 // (°C) Turn on PSU over this temperature
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE_BED 3 
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  #define DEFAULT_bedKp 61.45
  #define DEFAULT_bedKi 8.0
  #define DEFAULT_bedKd 208.07
 ...
 *
 */
#define Z_MIN_PROBE_PIN 2//32 // Pin 32 is the RAMPS default
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -3, 0 }
...
#define X_MIN_POS -27.5
#define Y_MIN_POS -17.5
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 22.5)
#define Y_MAX_POS (Y_BED_SIZE + 22.5)
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT 0.6  // (mm) Z height of nozzle at leveling points
...
// #define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.37
  #define XY_DIAG_BD 141.45
  #define XY_SIDE_AD 100.0
  ...
  // #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 141.34
    #define XZ_DIAG_BD 141.40
    // #define XZ_SKEW_FACTOR 0.0
    #define XZ_SIDE_AD 99.93

    #define YZ_DIAG_AC 141.35
    #define YZ_DIAG_BD 141.22
    #define YZ_SIDE_AD 99.85
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 1), (Y_MAX_POS - 1), 0 }
